...
//       backgroundColor: AppColorsLight.gray600,
//       hoverColor: AppColorsLight.gray700,
//       focusColor: AppColorsLight.gray600,
//     ),
//   );
// }
...
ElevatedButtonThemeData elevatedButtonTheme(BuildContext context) {
  return ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
      ...
      foregroundColor: AppColorsLight.gray50,
      ...
      backgroundColor: WidgetStateProperty.resolveWith<Color>((states) {
        if (states.contains(WidgetState.disabled)) {
          return AppColorsLight.gray900;
        }
        if (states.contains(WidgetState.pressed)) return AppColorsLight.gray800;
        if (states.contains(WidgetState.hovered)) return AppColorsLight.gray700;
        return AppColorsLight.gray900;
      }),
    ),
  );
